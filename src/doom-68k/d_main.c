...
void D_Display(void) {
    static doomboolean viewactivestate = false;
    static doomboolean menuactivestate = false;
    static doomboolean inhelpscreensstate = false;
    static doomboolean fullscreen = false;
